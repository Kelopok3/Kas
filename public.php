...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="dist/img/masjid.jpg"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light"> Masjid Darul Muttaqin</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">CP : 082234118505</a>
        </div>
      </div>
  ...
  <footer class="main-footer">
    ...
    Copyright &copy;<a target="_blank" href="https://www.instagram.com/aulia_yahyaharindra"><strong> kelompok 3 teori bahasa dan automata</strong></a>
    All rights reserved.
  </footer>
